...
class TestStudent(unittest.TestCase):
    ...
    * Call a method named apply_extension that will take a number of as an argument on the student instance to update end:date.
    * Assert whether the instance's end_date equals the old end date plus the days argument that was passed in using timedelta.
    * Run the test to confirm that the new method is filling.
    ...
    * Run the test to confirm they are working.
    ...
    def test_course__schedule_success(self):
    ...
    def test_course__schedule_failed(self):
        with patch("student.requests.get") as mocked_get:
